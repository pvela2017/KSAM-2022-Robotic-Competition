...
def merge_bbox(inference_data, info, predictor):
    ...
    for i in range(vertical_tile_size * horizontal_tile_size):
        ...
        for j in range(len(inference_data[i])):
            ...
            print(f'{i}, {j}, {idx}, {tile_matching}')

            if len(tile) == 0:
                continue
            if tile_matching == False and tile[2] > 320 * (i%3+1) * (1-vertival_threshold*0.1) and tile[2] < 320 * (i%3+1) * (1+vertival_threshold*0.1):
                print(320 * (i%3+1))
                print(320 * (i%3+1) * (1-vertival_threshold*0.1), 320 * (i%3+1) * (1+vertival_threshold*0.1))    
                print(tile[2])

                sub_tile_X1 = int(width / 3 * (i%3+1) - (( tile[2] - tile[0] )*1.5) * height / 960 )
                sub_tile_X2 = int(width / 3 * (i%3+1) + (( tile[2] - tile[0] )*1.5) * height / 960 )
                sub_tile_Y1 = int(tile[1] * width / 960)
                sub_tile_Y2 = int(tile[3] * width / 960)
                ...
                temp__ = [tile[0], tile[1], tile[2] + (tile[2] - tile[0]), tile[3], 1,1,1]
    ...
    for i in range(vertical_tile_size * horizontal_tile_size - vertical_tile_size):
        for j in range(len(inference_data[i])):
            ...
            '''if tile_matching == False and tile[3] > 320 * int(i/3+1) * (1-vertival_threshold*0.1) and tile[3] < 320 * int(i/3+1) * (1+vertival_threshold*0.1):
            ...
            #print(f'{i}, {j}, {idx}, {tile_matching}')
            print('tile:', tile)
            # if tile_matching == False and target_tile[1] > 320 * int(i/3+1) * (1-vertival_threshold*0.1) and target_tile[1] < 320 * int(i/3+1) * (1+vertival_threshold*0.1):
            # if tile_matching == False and target_tile[1] < 320 * int(i/3+1) * (1+vertival_threshold*0.1) and target_tile[1] > 320 * int(i/3+1) * (1-vertival_threshold*0.1):
            if i < 2:
                continue
            if len(tile) == 0:
            ...
            if tile_matching == False and tile[1] < 210 * int(i/3) * (1+vertival_threshold*0.1) and tile[1] > 210 * int(i/3) * (1-vertival_threshold*0.1):
                ...
                # temp__ = [tile[0], tile[1], tile[2] + (tile[2] - tile[0]), tile[3], 1,1,1]
                temp__ = [tile[0], tile[1] - (tile[3] - tile[1]) , tile[2], tile[3], 1,1,1]
